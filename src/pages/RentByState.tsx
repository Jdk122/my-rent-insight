  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO
        ...
        jsonLd={[
          ...
          },
          {
            ...
            variableMeasured: ['Fair Market Rent', 'Median Rent', 'Year-over-Year Rent Change', 'Rent by Bedroom Count'],
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 md:py-16 flex-1 w-full">
        ...
        {/* FAQ */}
        <section className="mb-12">
          <h2 className="font-display text-2xl text-foreground mb-4 tracking-tight">Questions about rent in {stateName}</h2>
