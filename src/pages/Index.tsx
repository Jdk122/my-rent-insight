    ...
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden" ref={topRef}>
      ...
      {isLoading ? (
        ...
        <main className="max-w-[620px] mx-auto px-5 sm:px-6 pt-6 sm:pt-16 md:pt-24 pb-10 sm:pb-14">
          <p className="font-display text-[1.5rem] sm:text-[2rem] text-muted-foreground leading-[1.2] tracking-tight font-semibold" style={{ letterSpacing: '-0.02em' }}>
            Most renters overpay.
          </p>
          <h1 className="font-display text-[1.85rem] sm:text-[clamp(2.5rem,6vw,4rem)] text-foreground leading-[1.08] tracking-tight mt-1 sm:mt-2" style={{ letterSpacing: '-0.02em' }}>
            Is your increase <span className="text-primary">above market?</span>
          </h1>
