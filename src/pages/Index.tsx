      ...
      {isLoading ? (
        ...
        <main className="max-w-[620px] md:max-w-[860px] mx-auto px-5 sm:px-6 pt-6 sm:pt-14 md:pt-10 pb-10 sm:pb-14 md:pb-16">
          <div className="md:grid md:grid-cols-[1fr_390px] md:gap-8 md:items-center">
            ...
            <div>
              <h1 className="font-display text-[1.85rem] sm:text-[clamp(2rem,5vw,3rem)] md:text-[38px] text-foreground leading-[1.08] md:leading-[1.12] tracking-tight font-extrabold" style={{ letterSpacing: '-0.02em' }}>
              ...
              <div className="hidden md:block mt-3">
                <div className="border-t border-border/60 pt-3 pb-2 px-1">
                  <p className="text-[13px] text-foreground/40 tracking-wide">
