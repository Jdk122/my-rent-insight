...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden" ref={topRef}>
      ...
      >
        <img src="/renewalreply-wordmark.png" alt="RenewalReply" className="h-7 sm:h-8 cursor-pointer hover:scale-105 transition-transform duration-200 shrink-0" onClick={() => { setResults(null); setFormKey(k => k + 1); setCapturedEmail(''); window.scrollTo({ top: 0 }); }} />
