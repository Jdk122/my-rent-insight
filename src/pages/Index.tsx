    ...
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden" ref={topRef}>
          ...
          },
          {
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "RenewalReply covers 38,000+ US zip codes using HUD Fair Market Rent data, making it one of the most comprehensive rent fairness tools available."
                }
              }
            ]
          }
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            to={`/what-should-i-pay${results ? `?zip=${results.rentData.zip}&bedrooms=${results.formData.bedrooms === 'studio' ? 0 : results.formData.bedrooms === 'oneBr' ? 1 : results.formData.bedrooms === 'twoBr' ? 2 : results.formData.bedrooms === 'threeBr' ? 3 : 4}` : ''}`}
