  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden" ref={topRef}>
      ...
      {isLoading ? (
        ...
        <main className="max-w-[620px] md:max-w-[1080px] mx-auto px-5 sm:px-6 pt-6 sm:pt-14 md:pt-[72px] pb-10 sm:pb-14 md:pb-16">
          <div className="md:grid md:grid-cols-[1fr_380px] md:gap-8 md:items-start">
            {/* Left column: sales message */}
            <div>
              <h1 className="font-display text-[1.85rem] sm:text-[clamp(2rem,5vw,3rem)] md:text-[clamp(48px,4.2vw,62px)] text-foreground leading-[1.08] md:leading-[1.08] tracking-tight font-extrabold" style={{ letterSpacing: '-0.03em' }}>
                Is your rent increase <span className="text-primary">above&nbsp;market?</span>
              </h1>
              <p className="mt-2 sm:mt-3 md:mt-5 text-[15px] sm:text-lg md:text-[clamp(18px,1.5vw,22px)] text-muted-foreground md:text-foreground/60 max-w-[600px] leading-relaxed font-normal tracking-tight md:whitespace-nowrap">
                Find out in 10 seconds — free, no account needed.
              </p>

              {/* Value props */}
              <div className="mt-3 sm:mt-5 md:mt-7 flex flex-col gap-1.5 sm:gap-2 md:gap-4 max-w-[520px]">
                <div className="flex items-start gap-2 md:gap-3">
                  <span className="text-primary mt-0.5 shrink-0"><MessageSquareText size={15} className="md:w-[20px] md:h-[20px]" /></span>
                  <span className="text-[14px] md:text-[clamp(16px,1.2vw,19px)] text-muted-foreground md:text-foreground/55 leading-snug"><strong className="text-foreground font-bold">Negotiation letter</strong> backed by your local data</span>
                </div>
                <div className="flex items-start gap-2 md:gap-3">
                  <span className="text-primary mt-0.5 shrink-0"><Calculator size={15} className="md:w-[20px] md:h-[20px]" /></span>
                  <span className="text-[14px] md:text-[clamp(16px,1.2vw,19px)] text-muted-foreground md:text-foreground/55 leading-snug"><strong className="text-foreground font-bold">Counter-offer range</strong> from real comps nearby</span>
                </div>
              </div>
              ...
              <div className="hidden md:block mt-5">
                <div className="border-t border-border/50 pt-3 pb-2">
                  <p className="text-[12px] text-foreground/40 tracking-wider uppercase whitespace-nowrap">
