  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden" ref={topRef}>
      ...
      {isLoading ? (
        ...
        <main className="max-w-[620px] md:max-w-[960px] mx-auto px-5 sm:px-6 pt-6 sm:pt-14 <main className="max-w-[620px] md:max-w-[960px] mx-auto px-5 sm:px-6 pt-6 sm:pt-14 md:pt-[90px] pb-10 sm:pb-14 md:pb-16"> pb-10 sm:pb-14 md:pb-16">
