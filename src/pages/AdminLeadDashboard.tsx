    ...
    <div className="max-w-[1400px] mx-auto px-4 py-6 space-y-6">
      ...
      {statsLoading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <StatCard label="Revenue" value={`$${((stats.purchases ?? 0) <StatCard label="Revenue" value={`$${((stats.purchases ?? 0) * 1.99).toFixed(2)}`} />).toFixed(2)}`} />
                    ...
                    >
                      ...
                      <td className="px-2 py-2">
                        <span className="flex items-center gap-1">
                          {r.purchased && <span title="{r.purchased && <span title="Purchased — $1.99">💰</span>}">💰</span>}
                          {r.verdict_label ? (
