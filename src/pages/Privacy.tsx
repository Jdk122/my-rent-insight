      ...
      <main className="max-w-[620px] mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p>
              We never sell, rent, or share your personal information with third parties. Your data is used
              solely to provide the RenewalReply service and is not monetized in any way.
            </p>
          </section>
