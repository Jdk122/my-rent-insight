  ...
  return (
    <div className="brand-card">
      ...
      <p className="text-sm text-muted-foreground mb-5">
        Browse current {bedroomLabel[bedrooms]} in {zip} to see if your landlord's number holds up.
      </p>
      ...
      <div className="flex flex-wrap gap-3">
        {links.map((link) => (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md border border-border text-sm font-mono font-medium text-foreground hover:bg-secondary transition-colors group"
          >
            {link.name}
