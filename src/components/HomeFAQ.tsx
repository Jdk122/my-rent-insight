...
const faqs: { q: string; a: React.ReactNode }[] = [
  ...
  },
  {
    ...
    a: 'Yes — completely free. You get a full analysis with comparable rents, a counter-offer range, and a ready-to-send negotiation letter. No account or payment required.',
  },
  {
