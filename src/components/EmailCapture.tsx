      ...
      <form onSubmit={handleSubmit} className="max-w-[440px] mx-auto space-y-2">
        <div className="flex gap-2">
          <input
            ...
            required
            autoComplete="email"
            className="flex-1 min-w-0 px-4 py-3 text-base md:text-sm border border-border rounded-lg bg-card text-foreground outline-none focus:border-foreground transition-colors placeholder:text-muted-foreground/50"
          />
