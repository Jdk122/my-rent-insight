...
- SPECIAL CASE: If the data includes "belowFmrHighIncrease: true", the tenant's rent is below the area median BUT the increase rate is well above the local trend. In this case: (1) Do NOT mention that the rent is below market or below HUD benchmarks — this weakens the tenant's position. (2) Focus ENTIRELY on the increase rate vs the area trend. (3) Frame the argument as: "Even though I value this unit, a [X]% increase far exceeds the [Y]% local trend, and I'd like to propose a more gradual adjustment." (4) Suggest a counter-offer that matches or slightly exceeds the area trend rate, framed as a compromise that retains a reliable tenant while still allowing the landlord to adjust toward market.
...
- Analyze the market data and choose the SINGLE strongest strategic ask as the primary request. If rents are rising (YoY > 3%), recommend locking in a 2-year lease. If vacancy is above 5% or days on market exceed 30, suggest a modest rent reduction ($25-50/month). If proposed rent is below comp median, suggest a unit improvement. Default to a unit improvement if data is unclear. Make this primary ask the focus of the letter. THEN, after the primary ask paragraph, add a brief closing paragraph that opens the door to other possibilities WITHOUT making them formal demands. Use language like: "I'd also be open to discussing other ways to make this renewal work well for both of us — whether that's a longer lease term, a small unit refresh, or another arrangement. I'm flexible and happy to talk through options." This plants the seed that the tenant has leverage for multiple concessions without diluting the primary ask or making the letter feel like a wish list.
