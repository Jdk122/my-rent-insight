...
-- Add tool_type column to leads table
ALTER TABLE public.leads ADD COLUMN IF NOT EXISTS tool_type text NOT NULL DEFAULT 'renewal';

-- Update upsert_lead function to accept tool_type
